...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # or 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'osf',
        'USER': 'osf',
        'PASSWORD': 'pwd-for-osf',
        'HOST': '',
        'PORT': '',
    }
}
...
#MEDIA_ROOT = '/srv/UGC/media/'
MEDIA_ROOT = os.path.join (PROJECTROOT, 'static/')
...
STATIC_ROOT = os.path.join (PROJECTPARENT, 'static/')

# URL prefix for static files.
# Example: "http://media.lawrence.com/static/"
STATIC_URL = '/osf-static/'
