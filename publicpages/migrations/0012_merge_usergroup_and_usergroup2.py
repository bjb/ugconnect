...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserGroup.meet_weekday'
        db.add_column('publicpages_usergroup', 'meet_weekday',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.meet_week_of_month'
        db.add_column('publicpages_usergroup', 'meet_week_of_month',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.meet_description'
        db.add_column('publicpages_usergroup', 'meet_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.location_name'
        db.add_column('publicpages_usergroup', 'location_name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.location_address'
        db.add_column('publicpages_usergroup', 'location_address',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.location_note'
        db.add_column('publicpages_usergroup', 'location_note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.meeting_time'
        db.add_column('publicpages_usergroup', 'meeting_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.web_site'
        db.add_column('publicpages_usergroup', 'web_site',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.email_site'
        db.add_column('publicpages_usergroup', 'email_site',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.other_url'
        db.add_column('publicpages_usergroup', 'other_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserGroup.meet_weekday'
        db.delete_column('publicpages_usergroup', 'meet_weekday')

        # Deleting field 'UserGroup.meet_week_of_month'
        db.delete_column('publicpages_usergroup', 'meet_week_of_month')

        # Deleting field 'UserGroup.meet_description'
        db.delete_column('publicpages_usergroup', 'meet_description')

        # Deleting field 'UserGroup.location_name'
        db.delete_column('publicpages_usergroup', 'location_name')

        # Deleting field 'UserGroup.location_address'
        db.delete_column('publicpages_usergroup', 'location_address')

        # Deleting field 'UserGroup.location_note'
        db.delete_column('publicpages_usergroup', 'location_note')

        # Deleting field 'UserGroup.meeting_time'
        db.delete_column('publicpages_usergroup', 'meeting_time')

        # Deleting field 'UserGroup.web_site'
        db.delete_column('publicpages_usergroup', 'web_site')

        # Deleting field 'UserGroup.email_site'
        db.delete_column('publicpages_usergroup', 'email_site')

        # Deleting field 'UserGroup.other_url'
        db.delete_column('publicpages_usergroup', 'other_url')
