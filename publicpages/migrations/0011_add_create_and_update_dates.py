...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BzflagTeam.date_created'
        db.add_column('publicpages_bzflagteam', 'date_created',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'BzflagTeam.last_updated'
        db.add_column('publicpages_bzflagteam', 'last_updated',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.date_created'
        db.add_column('publicpages_usergroup', 'date_created',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'UserGroup.last_updated'
        db.add_column('publicpages_usergroup', 'last_updated',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.date_created'
        db.add_column('publicpages_organization', 'date_created',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Organization.last_updated'
        db.add_column('publicpages_organization', 'last_updated',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sponsor.date_created'
        db.add_column('publicpages_sponsor', 'date_created',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Sponsor.last_updated'
        db.add_column('publicpages_sponsor', 'last_updated',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BzflagTeam.date_created'
        db.delete_column('publicpages_bzflagteam', 'date_created')

        # Deleting field 'BzflagTeam.last_updated'
        db.delete_column('publicpages_bzflagteam', 'last_updated')

        # Deleting field 'UserGroup.date_created'
        db.delete_column('publicpages_usergroup', 'date_created')

        # Deleting field 'UserGroup.last_updated'
        db.delete_column('publicpages_usergroup', 'last_updated')

        # Deleting field 'Organization.date_created'
        db.delete_column('publicpages_organization', 'date_created')

        # Deleting field 'Organization.last_updated'
        db.delete_column('publicpages_organization', 'last_updated')

        # Deleting field 'Sponsor.date_created'
        db.delete_column('publicpages_sponsor', 'date_created')

        # Deleting field 'Sponsor.last_updated'
        db.delete_column('publicpages_sponsor', 'last_updated')
