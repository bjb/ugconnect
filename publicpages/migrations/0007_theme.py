...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Theme'
        db.create_table('publicpages_theme', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('headergraphic', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('bullet', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('favicon', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal('publicpages', ['Theme'])

        # Adding model 'UserProfile'
        db.create_table('publicpages_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publicpages.Theme'], null=True, blank=True)),
        ))
        db.send_create_signal('publicpages', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'Theme'
        db.delete_table('publicpages_theme')

        # Deleting model 'UserProfile'
        db.delete_table('publicpages_userprofile')
