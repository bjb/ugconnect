...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BzflagTeam'
        db.create_table('publicpages_bzflagteam', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('teamname', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('captain', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('navigator', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('weapons_specialist', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('padre', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('contactinfo', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('icon', self.gf('django.db.models.fields.files.ImageField')(default='images/default_bzflag_icon.png', max_length=100)),
            ('icon_approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('publicpages', ['BzflagTeam'])


    def backwards(self, orm):
        # Deleting model 'BzflagTeam'
        db.delete_table('publicpages_bzflagteam')
